...
<div id="node-<?php print $node->nid; ?>" class="<?php print $classes; ?> clearfix"<?php print $attributes; ?>>
  ...
  <div class="content clearfix"<?php print $content_attributes; ?>>
    ...
    <?php if ($view_mode == 'full'): ?>
      <div class="carousel-watch-container">
        <div class="carousel-watch" style="background: url(<?php print $image_url; ?>)">
          <iframe id="videoplayer" frameborder="0" scrolling="no" webkitallowfullscreen="true"
            mozallowfullscreen="true" allowfullscreen="true" class="lazy-loaded"
            src="<?php print $video_url; ?>"></iframe>
        </div>
      </div>
      <?php print render($content); ?>
    <?php else: ?>
      <div class="carousel-item">
        <textarea class="hidden video-embed">
          <iframe id="videoplayer" frameborder="0" scrolling="no" webkitallowfullscreen="true"
            mozallowfullscreen="true" allowfullscreen="true" class="lazy-loaded"
            src="<?php print $video_url; ?>"></iframe>
        </textarea>
